				...
				<div class="content content-box">
					...
					<div class="desc">
						<p>Saya seorang penjelajah (explorer). Saya suka dengan tempat baru yang dapat membuat fully imagined dan artistik. 
							Pada sisi lain, saya menekuni bidang subset pada Artificial Intelligence, Jaringan, dan mobile apps.
						</p>
						<div class="info-list">
							<ul>
								<li><strong>Surel:</strong> gusti.anton@outlook.co.id</li>
								<li><strong>Github:</strong> antonsurya22</li>
								<li><strong>LinkedIn:</strong> anton-gusti</li>
							</ul>
						</div>
						<div class="bts">
							<a href="{{URL::to('/')}}/assets/pdf/cv_anton.pdf" class="btn hover-animated">
				...
				<div class="content">
					...
					<div class="service-col">
						<div class="service-item content-box">
							<div class="icon"><span class="fas fa-robot"></span></div>
							<div class="name">Artificial Intelligence</div>
							<div class="text">Computer Vision, Natural Language Processing, Reinforcement Learning, Data Science</div>
						</div>
					</div>
						...
						<div class="col col-md">
							...
							<div class="resume-items">
								<div class="resume-item content-box">
									...
									<div class="name">Radio Republik Indonesia</div>
									<div class="text">Project Intern</div>
								</div>
								<div class="resume-item content-box">
						...
						<div class="col col-md">
							...
							<div class="resume-items">
								<div class="resume-item content-box active">
									...
									<div class="name"><a target="_blank" href="https://mcut.edu.tw/">Ming-Chi University of Technology</a></div>
									<div class="text">Ming-Chi University of Technology</div>
								</div>
								<div class="resume-item content-box">
									<div class="date">2019-2022</div>
									<div class="name"><a target="_blank" href="https://pti.undiksha.ac.id/">Pendidikan Teknik Informatika</a></div>
