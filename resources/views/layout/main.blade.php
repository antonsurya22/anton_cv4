	...
	<div class="container">
		...
		<header class="header">
			<div class="head-top">
				...
				<div class="logo hover-masks-logo">
					<a href="{{URL::to('/')}}/assets/pdf/cv_anton.pdf">
					...
					<div class="top-menu-nav">	
						<div class="menu-topmenu-container">
							<ul class="menu">
								...
								<li class="menu-item menu-item-menu-item">
									<a href="{{route('Project')}}" class="nav-link scrollto {{ ($title === "Project") ? 'active' : '' }}">Project</a>
								</li>
								<li class="menu-item menu-item-menu-item">
		...
		<footer class="footer">
			<div class="copy">
				...
				<p>Created with <span class="fas fa-heart"></span> Antonie - 2024</p>
			</div>
			<div class="soc-box">
				<div class="follow-label">Ikuti Saya</div>
				<div class="soc">
					<a target="_blank" href="https://github.com/antonsurya22">
						<span class="icon fab fa-github"></span>
					</a>	
					<a target="_blank" href="https://www.linkedin.com/in/anton-gusti">
						<span class="icon fab fa-linkedin"></span>
					</a>
					<a target="_blank" href="https://www.instagram.com/anton_gusti">
						<span class="icon fab fa-instagram"></span>
					</a>
					<a target="_blank" href="https://polihartikelanyar.blogspot.co.id">
						<span class="icon fab fa-blogger"></span>
					</a>
